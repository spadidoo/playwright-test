...
class DuckDuckGoResultPage:
    ...
    # gets results link titles and stores them in a list. waits for the 5th results to load
    def result_link_titles(self) -> List[str]:
        self.result_links.nth(4).wait_for()
        return self.result_links.all_text_contents()
    
    # checks if the search results contai the searched phrase; must be at least 1 match.
    def results_link_titles_contain_phrase(self, phrase: str, minimum: int = 1) -> bool:
